...
"""
    ...
    Command line:
    python "pathToFile/bom_lcsc.py" "%I" "%production/O.csv"
"""
...
out.writerow(['Ref', 'Qnty', 'Value', 'Cmp name', 'Footprint', 'Description', 'JLC Part','LCSC Part'])
...
for group in grouped:
	...
	fromNetlistText( c.getField("JLC Part") ),
